...
return [
    ...
    'app_cart_new' => [[], ['_controller' => 'App\\Controller\\CartController::new'], [], [['text', '/cart/new']], [], [], []],
    'app_cart_show' => [['id'], ['_controller' => 'App\\Controller\\CartController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/cart']], [], [], []],
    'app_cart_edit' => [['id'], ['_controller' => 'App\\Controller\\CartController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/cart']], [], [], []],
    'app_cart_delete' => [['id'], ['_controller' => 'App\\Controller\\CartController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/cart']], [], [], []],
    ...
    'app_product_new_post' => [[], ['_controller' => 'App\\Controller\\ProductController::newPost'], [], [['text', '/product/new']], [], [], []],
    ...
    'App\Controller\CartController::new' => [[], ['_controller' => 'App\\Controller\\CartController::new'], [], [['text', '/cart/new']], [], [], []],
    'App\Controller\CartController::show' => [['id'], ['_controller' => 'App\\Controller\\CartController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/cart']], [], [], []],
    'App\Controller\CartController::edit' => [['id'], ['_controller' => 'App\\Controller\\CartController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/cart']], [], [], []],
    'App\Controller\CartController::delete' => [['id'], ['_controller' => 'App\\Controller\\CartController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/cart']], [], [], []],
    ...
    'App\Controller\ProductController::newPost' => [[], ['_controller' => 'App\\Controller\\ProductController::newPost'], [], [['text', '/product/new']], [], [], []],
